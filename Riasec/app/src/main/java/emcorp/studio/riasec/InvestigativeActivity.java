...
public class InvestigativeActivity extends AppCompatActivity {
    ImageButton btnSelanjutnya;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_investigative);
        ...
        btnSelanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(InvestigativeActivity.this,ArtisticActivity.class));
                finish();
            }
        });
    }
